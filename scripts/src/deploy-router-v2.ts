...
const contractPath = resolve(__dirname, "../../contracts/BasePayRouterV2.json");
...
if (balance === 0n) { console.error("ERROR: 0 ETH — need gas"); process.exit(1); }

console.log("Deploying BasePayRouterV2 to Base Mainnet...");
