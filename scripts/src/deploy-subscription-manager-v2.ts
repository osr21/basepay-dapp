...
const contractPath = resolve(__dirname, "../../contracts/SubscriptionManagerV2.json");
...
console.log("Deploying SubscriptionManagerV2...");
...
console.log("\n✅ Deployed SubscriptionManagerV2!");
console.log("Contract address:", receipt.contractAddress);
console.log("BaseScan:", `https://basescan.org/address/${receipt.contractAddress}`);
console.log(`  VITE_SUBSCRIPTION_MANAGER_ADDRESS=${receipt.contractAddress}`);
